		...
		<div class="container">
			...
			<header>
				<section id="form">
					<div class="row-fluid">
						<div class="span6">
							<form:form class="form-inline" action="./edit-cate/check.htm"
								enctype="multipart/form-data" modelAttribute="category">
								<fieldset>
									<div class="control-group">
										<label class="control-label" for="input_1">Mã Loại</label>
										<div class="controls">
											<form:input path="cate_id" class="input-medium" readonly="true"/>
											<form:errors path="cate_id"></form:errors>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="input_1">Tên Loại</label>
										<div class="controls">
											<form:input path="cate_name" class="input-xxlarge" />
											<form:errors path="cate_name"></form:errors>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="input_1">Mô tả</label>
										<div class="controls">
											<form:input path="description" class="input-xxlarge" />
