					...
					<ul id="topMenu" class="nav pull-right">
							...
							<div id="login" class="modal hide fade in" tabindex="-1"
								...
								<div class="modal-body">
									<form class="form-horizontal loginFrm" action="./login.htm">
										<input type="hidden" name="from" value="${pageContext.request.requestURL }">
						...
						<li class="" style="${user==null?'display: none;':''}">
							<form action="./logout.htm">
								<button name="btnLogout" style="margin-top: 20px;" class="btn" formaction="logout.htm">Logout</button>
							</form>
						</li>
					</ul>
				</div>
