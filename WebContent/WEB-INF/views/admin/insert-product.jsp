		...
		<div class="container">
			...
			<header>
				<section id="form">
					<div class="row-fluid">
						<div class="span6">
							<form:form class="form-inline" action="save-product.htm"
								enctype="multipart/form-data" modelAttribute="newProd">
								<fieldset>
									...
									<div class="control-group">
										...
										<div class="controls">
											<form:errors path="img1"></form:errors> <br>
											<form:input path="img1" class="input-file" id="fileInput1" type="file"
												name="a1" onchange="readURL1(this);"/> <br> <img
												id="a1" src="./${newProd.img1.getOriginalFilename() }" alt="" />
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="fileInput2">Ảnh 2</label>
										<div class="controls">
											<form:errors path="img2"></form:errors> <br>
											<form:input path="img2" class="input-file" id="fileInput2" type="file"
												name="a2" onchange="readURL2(this);"/> <br> <img
												id="a2" src="#" alt="" />
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
									<form:errors path="img3"></form:errors> <br>
											<form:input path="img3" class="input-file" id="fileInput3" type="file"
												name="a3" onchange="readURL3(this);"/> <br> <img
												id="a3" src="./${newProd.img3.getOriginalFilename() }" alt="" />
										</div>
									</div>
									<div class="control-group">
